...
private logField(evt, Closure c) {
    ...
    httpPostJson(uri: "https://flickering-torch-2690.firebaseio.com/events/${evt.deviceId}/${evt.name}.json",   body:[device: evt.deviceId, name: evt.name, value: evt.value, date: evt.isoDate, unit: evt.unit]) {
