...
def selectCapability() {
    ...
    return dynamicPage(pageProperties) {
		section() {
        	input "mycapability", "enum", title: "Which Capability?", metadata:[values:["alarm", "battery", "button", "configuration", "contactSensor", "illuminanceMeasurement", "motionSensor", "polling", "presenceSensor", "relativeHumidityMeasurement", "sensor", "switch", "temperatureMeasurement", "thermostatMode", "threeAxisMeasurement", "waterSensor", "sleepSensor"]], required: true, multiple: false
		}
	}
}
